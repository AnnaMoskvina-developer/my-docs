...
```
cd existing_repo
git remote add origin https://hub.mos.ru/ann-moskvina2008/my-docs.git
git branch -M main
...
- [ ] [Настройте интеграцию](https://hub.mos.ru/ann-moskvina2008/my-docs/-/settings/integrations)
